...
public class CauseResourceIT {
    ...
    private static final Long DEFAULT_UNLOCK_CURRENCY_AMOUNT = 1L;
    private static final Long UPDATED_UNLOCK_CURRENCY_AMOUNT = 2L;
    ...
    public static Cause createEntity() {
        Cause cause = new Cause()
            ...
            .unlockCurrencyAmount(DEFAULT_UNLOCK_CURRENCY_AMOUNT);
        return cause;
    }
    ...
    public void createCause() throws Exception {
        ...
        assertThat(testCause.getUnlockCurrencyAmount()).isEqualTo(DEFAULT_UNLOCK_CURRENCY_AMOUNT);
    }
    ...
    public void getAllCauses() throws Exception {
        ...
        restCauseMockMvc.perform(get("/api/causes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].unlockCurrencyAmount").value(hasItem(DEFAULT_UNLOCK_CURRENCY_AMOUNT.intValue())));
    }
    ...
    public void getCause() throws Exception {
        ...
        restCauseMockMvc.perform(get("/api/causes/{id}", cause.getId()))
            ...
            .andExpect(jsonPath("$.unlockCurrencyAmount").value(DEFAULT_UNLOCK_CURRENCY_AMOUNT.intValue()));
    }
    ...
    public void updateCause() throws Exception {
        ...
        updatedCause
            ...
            .unlockCurrencyAmount(UPDATED_UNLOCK_CURRENCY_AMOUNT);
        ...
        assertThat(testCause.getUnlockCurrencyAmount()).isEqualTo(UPDATED_UNLOCK_CURRENCY_AMOUNT);
    }
