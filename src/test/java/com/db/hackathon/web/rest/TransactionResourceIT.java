...
public class TransactionResourceIT {
    ...
    private static final String DEFAULT_CAUSE_ID = "AAAAAAAAAA";
    private static final String UPDATED_CAUSE_ID = "BBBBBBBBBB";

    private static final String DEFAULT_STATUS_ID = "AAAAAAAAAA";
    private static final String UPDATED_STATUS_ID = "BBBBBBBBBB";

    private static final Long DEFAULT_TRANSACTION_AMOUNT = 1L;
    private static final Long UPDATED_TRANSACTION_AMOUNT = 2L;
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getCauseId()).isEqualTo(DEFAULT_CAUSE_ID);
        assertThat(testTransaction.getStatusId()).isEqualTo(DEFAULT_STATUS_ID);
    ...
    public void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].causeId").value(hasItem(DEFAULT_CAUSE_ID.toString())))
    ...
    public void getTransaction() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions/{id}", transaction.getId()))
            ...
            .andExpect(jsonPath("$.causeId").value(DEFAULT_CAUSE_ID.toString()))
    ...
    public void updateTransaction() throws Exception {
        ...
        assertThat(testTransaction.getCauseId()).isEqualTo(UPDATED_CAUSE_ID);
        assertThat(testTransaction.getStatusId()).isEqualTo(UPDATED_STATUS_ID);
